...
.LFE15:
	...
	.align 8
.LC0:
	.string	"8 48 4 6 num:32 64 4 7 numb:43 80 4 4 b:50 96 4 4 c:50 112 4 4 d:50 128 4 1 m 144 4 1 n 160 15 4 a:28"
...
.L10:
	...
	movq	%rax, %r14
.L12:
	.loc 1 34 32 is_stmt 0 discriminator 4
	testq	%r12, %r12
	js	.L61
	.loc 1 34 32 discriminator 3
	movq	%r14, %rdi
	call	_ZN5vnodeC1Ev
	addq	$24, %r14
	subq	$1, %r12
...
.L86:
	...
	cmpl	-80(%rbp), %eax
	jge	.L84
	.loc 1 155 42 discriminator 2
	movl	-64(%rbp), %eax
	movslq	%eax, %rdx
	.loc 1 155 43 discriminator 2
	movq	%rdx, %rax
	addq	%rax, %rax
	addq	%rdx, %rax
	salq	$3, %rax
	...
	movq	-72(%rbp), %rax
	addq	%rdx, %rax
	.loc 1 155 45 discriminator 2
	movq	%rax, %rcx
	.loc 1 155 21 discriminator 2
	movl	-64(%rbp), %eax
	movslq	%eax, %rdx
	.loc 1 155 22 discriminator 2
	movq	%rdx, %rax
	addq	%rax, %rax
	addq	%rdx, %rax
	salq	$3, %rax
	...
	movq	-16(%rbp), %rax
	addq	%rdx, %rax
	.loc 1 155 15 discriminator 2
	movq	%rcx, %rsi
	movq	%rax, %rdi
	call	strcpy@PLT
	.loc 1 156 14 discriminator 2
	movl	-64(%rbp), %eax
	movslq	%eax, %rdx
	.loc 1 156 15 discriminator 2
	movq	%rdx, %rax
	addq	%rax, %rax
	addq	%rdx, %rax
	salq	$3, %rax
...
.L85:
	.loc 1 156 27 discriminator 2
	movq	$0, 16(%rax)
	.loc 1 153 5 is_stmt 1 discriminator 2
	addl	$1, -64(%rbp)
	jmp	.L86
.L84:
.LBE21:
...
.L95:
	...
	movq	-40(%rbp), %rax
	movl	4(%rax), %eax
	.loc 1 173 39 is_stmt 1 discriminator 1
	cmpl	%eax, -44(%rbp)
	jle	.L94
	.loc 1 173 70 discriminator 2
	movq	-40(%rbp), %rax
	movq	%rax, %rdx
	movq	%rdx, %rax
	shrq	$3, %rax
...
.L96:
	...
	movq	-40(%rbp), %rax
	movl	(%rax), %ecx
	.loc 1 173 76 is_stmt 1 discriminator 2
	movslq	%ecx, %rax
	leaq	0(,%rax,4), %rdx
	leaq	flag2(%rip), %rax
	addq	%rdx, %rax
...
.L97:
	...
	leaq	flag2(%rip), %rax
	movl	(%rdx,%rax), %eax
	.loc 1 173 58 is_stmt 1 discriminator 2
	testl	%eax, %eax
	jne	.L94
	.loc 1 175 29
	movq	-40(%rbp), %rax

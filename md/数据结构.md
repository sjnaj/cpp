...
对于一颗已有的二叉树， 如果我们为它添加一系列新结点，使得它原有的所有结点的度都为**2**，那么我们就得到了一颗扩充二叉树
...
3+4重构：我们设g(x)为最低的失衡结点，考察祖孙三代：g~p~v,按照中序遍历次序将其重命名为：a<b<c。
...
![a](https://img-blog.csdnimg.cn/3233f8af1ae6423daf1cd7546fe6740a.png)
